...
global RATE_List AP_List CLIENT_List SEND_List RECEIVE_List;
...
AP_List = (1:58);
CLIENT_List = (59:1682);
SEND_List = [];% ues to dection colision, store sending AP list
APNum = length(AP_List);
ClientNum = length(CLIENT_List); 
RECEIVE_List = cell(1,APNum);% ues to dection colision, store clients for each AP list