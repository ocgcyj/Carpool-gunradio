...
CW_max_priority = 5;
APNum_priority = 2;
Priority_update_interval = 100*1e-3;% 100ms, n = 10ms, k=(0:10)
n_interval = 10;% 10ms
AP_k_priority_dist = cell(1, APNum_priority);
QueueSize = 50;
PriorityLevel = 10;
k_log = @(x) PriorityLevel*log(x + 1)/log(QueueSize);
t_to_k = @(t) ceil(mod(t*1000, Priority_update_interval*1000) / n_interval);
...
% WIFOX related, Priority_update EVENT
NewEvent.time = 0;
